...
function anderson_customize_controls_js() {
	...
	wp_localize_script( 'anderson-lite-customizer-controls', 'anderson_theme_links', array(
		...
		'themeURL'	=> esc_url( 'https://themezee.com/themes/anderson/?utm_source=customizer&utm_medium=textlink&utm_campaign=anderson&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'anderson-lite' ),
		'docuURL'	=> esc_url( 'https://themezee.com/docs/anderson-documentation/?utm_source=customizer&utm_medium=textlink&utm_campaign=anderson&utm_content=documentation' ),
